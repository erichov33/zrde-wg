...
exports.DataSourceNodeExecutor = void 0;
const base_node_executor_1 = require("./base-node-executor");
/**
 * Executor for data source nodes
 */
class DataSourceNodeExecutor extends base_node_executor_1.BaseNodeExecutor {
    async execute(context) {
        try {
            ...
            return this.createErrorResult(error instanceof Error ? error.message : 'Data source execution failed');
        }
    }
    /**
     * Fetch data from specific source based on type
     */
    async fetchData(sourceType, config, context) {
        switch (sourceType) {
            case 'credit_bureau':
     ...
     */
    async fetchCreditBureauData(config, context) {
     ...
     */
    async fetchIncomeVerificationData(config, context) {
     ...
     */
    async fetchFraudDetectionData(config, context) {
     ...
     */
    async fetchKYCData(config, context) {
     ...
     * Fetch database data
     */
    async fetchDatabaseData(config, context) {
     ...
     * Fetch API data
     */
    async fetchAPIData(config, context) {
        // Simulate API call
     ...
     * Fetch file data
     */
    async fetchFileData(config, context) {
        // Simulate file read
     ...
     * Fetch default data
     */
    async fetchDefaultData(config, context) {
        return {
            source: 'default',
...
exports.DataSourceNodeExecutor = DataSourceNodeExecutor;
